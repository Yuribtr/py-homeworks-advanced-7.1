...
## Solution
- made class Stack with given methods
- made function that detects brackets balancing in string
- made CLI program which asks for a string to test
- wrote a tests for function
